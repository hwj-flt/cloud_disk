...
public class Directory implements Serializable {
    ...
    /**
     * 1-个人根目录 2-部门根目录 3-个人文件夹 4-部门文件夹 5-个人回收站 6-部门回收站
     */
    ...
    /**
     * 获取1-个人根目录 2-部门根目录 3-个人文件夹 4-部门文件夹 5-个人回收站 6-部门回收站
     *
     * @return DIRECT_TYPE - 1-个人根目录 2-部门根目录 3-个人文件夹 4-部门文件夹 5-个人回收站 6-部门回收站
     */
    ...
    /**
     * 设置1-个人根目录 2-部门根目录 3-个人文件夹 4-部门文件夹 5-个人回收站 6-部门回收站
     *
     * @param directType 1-个人根目录 2-部门根目录 3-个人文件夹 4-部门文件夹 5-个人回收站 6-部门回收站
     */
     ...
     * 获取所属部门ID
     *
     * @return DIRECT_BELONG_DEPART - 所属部门ID
     */
     ...
     * 设置所属部门ID
     *
     * @param directBelongDepart 所属部门ID
     */
     ...
     */
    public Integer getDirectDelete() {
        return directDelete;
    }
     ...
     */
    public void setDirectDelete(Integer directDelete) {
